...
class AddTabletul extends StatefulWidget {
  const AddTabletul({Key? key}) : super(key: key);

  @override
  State<AddTabletul> createState() => _AddTabletulState();
}

class _AddTabletulState extends State<AddTabletul> {
